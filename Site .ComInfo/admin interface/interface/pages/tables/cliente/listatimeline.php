	...
	echo "
		<table id='b'>
			<tr>
				...
				<th colspan=4 border=1>Ações</th>
				</tr>";
			while($e=mysqli_fetch_assoc($consulta)){
				...
				<td id='va'>".$e['equipamento']."</td>
						  ...
						  <td class='ed'><a href='editare.php?id=".$e['id']."'>
						  <img src='../img/editar.png' alt='Editar'></a></td>
						  <td class='ex'><a href='excluirtimeline.php?id=".$e['id']."'>
						  <img id='ex' src='../img/lixofechado.png''></a>
						  <td class='ex'><a href='testeAdd.php?id=".$e['id']."'>a</a>
						  </tr>";
			}
			echo "</table>";
