			        ...
			        <div class="container">
			            ...
			            <div class="collapse navbar-collapse menu-ui-design" id="navbar-menu">
			                ...
			                <li class=" smooth-menu active"></li>
			                    ...
			                    <li class="smooth-menu"><a href="">Sair</a></li>
				...
				<li>
				  ...
				  <div class="timeline-panel">
					...
					<div class="timeline-heading">
					  ...
					  <p><small class="text-muted"  style="color:rgb(0, 0, 0)"><i class="fas fa-laptop-medical" ></i> <?php ?></small></p>
					</div>
					...
					<?php 
                include('conexao.php');
				$sql="SELECT * FROM equipamento where id=7";	
				$consulta=mysqli_query($conexao,$sql);
				while($e=mysqli_fetch_assoc($consulta)){
				echo'
				<li class="timeline-inverted">
				  <div class="timeline-badge warning">
				  <i class="fas fa-pause-circle" style="color:rgb(0, 0, 0)">
				  </i></div>
				  <div class="timeline-panel">
					<div class="timeline-heading">
					  <h4 class="timeline-title"></h4>
