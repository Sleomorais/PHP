...
hr {
	...
	<center>
<h3>Adicionar Nova Timeline</h3>
<form method="post">
Data de Chegada: <br><input type="date" required="" name="datadechegada"><br>
Data de Entrega:<br> <input type="date" required="" name="datadeentrega"><br>
...
<br><select id="select" required="" name="quantidadedeetapas">
	...
	Cliente:<br><select id="select" required="" name="id_Cliente">
		...
		<input type="submit" value="Adicionar Nova Timeline">
</form>
<?php
	include('conexao.php');
	...
	if( $datadechegada && $datadeentrega && $equipamento && $quantidadedeetapas && $id_Cliente){
		$sql="INSERT INTO timeline VALUES(0,'$datadechegada','$datadeentrega','$equipamento','$quantidadedeetapas','$id_Cliente')";
